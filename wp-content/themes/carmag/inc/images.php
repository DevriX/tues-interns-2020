 ...
 */
function carmag_post_thumbnail_sizes_attr( $attr, $attachment, $size ) {
...
add_filter( 'wp_get_attachment_image_attributes', 'carmag_post_thumbnail_sizes_attr', 10 , 3 );
 ...
 * @since CarMag v1.1.0
 */
function carmag_featured_image( $size, $class = '', $attr = '' ) {
 ...
 * @since  CarMag v1.1.0
 */
function carmag_get_responsive_image() {
